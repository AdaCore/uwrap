...
package Wrapping.Runtime.Objects is
   ...
   --  templates, it is also used to provide one level of indirection
   --  between the variables and the actual objects (which may themselves
   --  be containers, such as the "text" type.
